...
from rentscraper.models import RentalListing, TempletonListing, WestwoodListings, MasterRentalData, BuildingDetails

def update_master_rental_data(request):
    ...
    def process_killam_listings():
        ...
        for listing in listings:
            ...
            MasterRentalData.objects.create(
                name=listing.title,
    ...
    # Clear the MasterRentalData table before inserting new data
    MasterRentalData.objects.all().delete()
